  ...
  return (
    <MobilePartnerLayout>
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-purple-50">
        ...
        <div className="px-3 sm:px-4 md:px-6 lg:px-8 pb-24 mt-6 sm:mt-8 md:mt-10 max-w-4xl mx-auto">
          {/* Profile Card */}
          <GlassCard delay={0.1}>
          ...
          {menuSections.map((section, sectionIndex) => (
            <div key={section.title} className="mt-4 sm:mt-6">
              <h3 className="text-xs sm:text-sm font-bold text-gray-500 uppercase tracking-wide mb-2 sm:mb-3 px-1 sm:px-2">
                {section.title}
              </h3>
          ...
          <div className="mt-4 sm:mt-6">
            <motion.button
              ...
              className="w-full py-3 sm:py-4 bg-gradient-to-r from-red-500 to-pink-500 hover:from-red-600 hover:to-pink-600 text-white font-bold rounded-xl sm:rounded-2xl shadow-lg flex items-center justify-center gap-2 transition-all text-sm sm:text-base"
            >
