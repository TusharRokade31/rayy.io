...
const ListingCreationWizard = () => {
  ...
  const handleNext = () => {
    if (step === 1) {
      ...
      if (listingData.trial_available && !listingData.trial_price_inr) {
        toast.error('Please set trial price');
        return;
      }
      setStep(4);
    } else if (step === 4) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Calculate pricing plans with proper values
      const pricingPlans = [
        {
          plan_type: 'trial',
          sessions_count: 1,
        ...
        },
        {
          plan_type: 'weekly_4',
          sessions_count: 4,
          price_inr: parseFloat((basePrice * 4 * 0.9).toFixed(2)),
          discount_percent: 10,
          active: true
        },
        {
          plan_type: 'weekly_8',
          sessions_count: 8,
          price_inr: parseFloat((basePrice * 8 * 0.85).toFixed(2)),
          discount_percent: 15,
          active: true
        },
        {
          plan_type: 'monthly_12',
          sessions_count: 12,
          price_inr: parseFloat((basePrice * 12 * 0.8).toFixed(2)),
          discount_percent: 20,
          active: true
        },
        {
          plan_type: 'monthly_16',
          sessions_count: 16,
          price_inr: parseFloat((basePrice * 16 * 0.75).toFixed(2)),
          discount_percent: 25,
          active: true
        }
      ];
      ...
      const payload = {
        ...
        // Media - extract just the data URLs (handle both object and string formats)
        ...
        // Flexible Booking V2
        plan_options: listingData.plan_options || [],
        batches: listingData.batches || []
      };

      if (isEditMode) {
        // Update existing listing (backend uses PATCH)
        ...
        toast.success('🎉 Listing created successfully with pricing plans!');
      }
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '2rem' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          <h1 style={{
            ...
            {isEditMode ? '✏️ Edit Listing' : '✨ Create New Listing'}
          </h1>
          <p style={{
            fontSize: '1.1rem',
            color: '#64748B',
            ...
            {isEditMode ? 'Update your class information' : 'Let\'s add your amazing class to rayy'}
          </p>
        </div>
            ...
            {[1, 2, 3, 4, 5, 6, 7].map(i => (
              <div key={i} style={{
                ...
                <div style={{
                  ...
                  height: '48px',
                  borderRadius: '50%',
                  background: step >= i ? 'linear-gradient(135deg, #6EE7B7 0%, #3B82F6 100%)' : '#e2e8f0',
                ...
                <div style={{
                  ...
                  {['Basic', 'Details', 'Pricing', 'Media', 'Plans', 'Batches', 'Review'][i - 1]}
                </div>
              </div>
            ))}
          </div>
        ...
        <div style={{
          ...
          <AnimatePresence mode="wait">
            ...
            {step === 1 && (
              ...
              >
                <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
                  <FileText size={48} style={{ color: '#6EE7B7', margin: '0 auto 1rem' }} />
                  <h2 style={{
                    fontSize: '2rem',
                    fontWeight: '700',
                    color: '#1E293B',
                ...
                {/* Online/Offline Selection - CRITICAL */}
                <div style={{
                  background: '#FEF3C7',
                  padding: '1.5rem',
                  borderRadius: '16px',
                ...
                {/* Venue Selection - Required for Offline */}
                {!listingData.is_online && (
                  <>
                    {/* Add New Venue Button - ALWAYS VISIBLE at top */}
                    {venues.length > 0 && (
            ...
            {step === 4 && (
              ...
              >
                <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
                  <Image size={48} style={{ color: '#8B5CF6', margin: '0 auto 1rem' }} />
                  <h2 style={{
                    fontSize: '2rem',
                    fontWeight: '700',
                    color: '#1E293B',
                  ...
                  <p style={{
                    ...
                    color: '#64748B',
                    fontFamily: 'Outfit, sans-serif'
                  }}>Photos, amenities & requirements</p>
                </div>
              ...
              >
                <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
                  ...
                  <p style={{
                    ...
                    color: '#64748B',
                    fontFamily: 'Outfit, sans-serif'
                  }}>Create custom plans with any number of sessions</p>
                </div>
              ...
              >
                <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
                  ...
                  <h2 style={{
                    ...
                    marginBottom: '0.5rem',
                    fontFamily: 'Outfit, sans-serif'
                  }}>Batch Configuration</h2>
                  <p style={{
                    fontSize: '1rem',
                    color: '#64748B',
                    fontFamily: 'Outfit, sans-serif'
                  }}>Set up batches with specific timings and capacity</p>
                </div>
            ...
            {step === 7 && (
              ...
              >
                <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
                  <CheckCircle2 size={48} style={{ color: '#6EE7B7', margin: '0 auto 1rem' }} />
                  <h2 style={{
                    fontSize: '2rem',
                    fontWeight: '700',
                    color: '#1E293B',
