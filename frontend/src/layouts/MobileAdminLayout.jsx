...
import { LayoutDashboard, Users, Building2, Package, Calendar, Settings } from 'lucide-react';
import { AuthContext } from '../App';

const MobileAdminLayout = ({ children, hideNav = false }) => {
                ...
                >
                  ...
                  {active && (
                    <motion.div
                      ...
                      className="absolute -top-1 left-1/2 transform -translate-x-1/2 w-12 h-1 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full"
